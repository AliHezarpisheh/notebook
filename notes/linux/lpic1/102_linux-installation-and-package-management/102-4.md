...
In context of Linux, A package manager is a software that goes through all these
...
- debian-binary: A text file with the version of the package format (usually "2.0").
...
![apt installing/upgrading steps](../images/apt.png)
...
difference between an apt repository and a ppa. An apt repo is a collection of packages,
