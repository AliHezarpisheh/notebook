...
| dev       | Device files, we already talked about it at [Determine and Configure Hardware Settings](../101_system-architecture/101-1.md) lesson.                                                                       |
...
| proc      | Virtual filesystem, providing an interface to kernel and system information and processes. We already talked about it in [Determine and Configure Hardware Settings](../101_system-architecture/101-1.md). |
...
- parted -> A modern program to manipulate disk partitions.
