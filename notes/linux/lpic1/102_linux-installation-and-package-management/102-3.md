...
- Static linking: In this way of linking, the executable program is added to the
  program. The program size gets big but the advantage of it is that no dependencies are
  needed in runtime.
...
> 💡 Libraries are mostly symlinked to the exact version of them. You can think of
